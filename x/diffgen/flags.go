...
func RegisterFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String("output-format", "", "Output format (image: png; video: gif, webm [requires ffmpeg], webm-lossless [requires ffmpeg+libvpx-vp9], webp)")
...
Diffusion Generation Flags (image + video, experimental):
      ...
      --output-format str   Output format (image: png; video: gif, webm [requires ffmpeg], webm-lossless [requires ffmpeg+libvpx-vp9], webp)
